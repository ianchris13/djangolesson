...
def store_gender(request):
    ...
    messages.success(request, 'Gender successfully save!')
...
def index_user(request):
    users= User.objects.select_related('gender') #SELECT * FROM users LEFT JOIN genders ON users_id = genders.gender_id
